...
<button class="button" value="Add reg" onclick="location.href='?page=Add_reg';" style="margin-right:100px;">Add register</button>
<button class="button" value="Edit" onclick="location.href='?page=Edit';">Edit data</button>
</section>
<section id="search">
